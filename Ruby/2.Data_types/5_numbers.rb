...
# You can also use the String#to_i method. However, this method is slightly more permissive and has a different
...
# 3: ROUNDING NUMBERS
# The round method will round a number up if the first digit after its decimal place is 5 or higher and round down if that digit is 4 or lower. 
# This takes in an optional argument for the precision you're looking for.
...
# 8: DIVIDING TWO NUMBERS
# When dividing two numbers pay attention to the type you want in return. Note that dividing two integers will invoke the integer division. 
# If your goal is to run the float division, at least one of the parameters should be of float type.
# Integer division:
3 / 2 # => 1
